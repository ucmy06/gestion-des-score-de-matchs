...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div class="mb-4">
            <p class="text-gray-700"><strong>Nom:</strong> {{ $team->name }}</p>
        </div>

        <div class="mb-6">
            <p class="text-gray-700"><strong>Logo:</strong></p>
            @if($team->logo)
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('employee.teams.edit', $team->id) }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">Modifier</a>
